          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@nextjsdemo.com</p>
                    <p className="text-gray-600">support@nextjsdemo.com</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-green-100 text-green-600 w-12 h-12 rounded-full flex items-center justify-center hover:bg-green-600 hover:text-white transition duration-300">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mt-12">
          ...
          <div className="bg-gray-200 h-64 rounded-lg flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm">123 Tech Street, San Francisco, CA 94103</p>
            </div>
          </div>
        </div>
      </div>
